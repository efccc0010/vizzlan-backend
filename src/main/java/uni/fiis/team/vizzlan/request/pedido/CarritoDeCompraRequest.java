...
public class CarritoDeCompraRequest {
    ...
    public CarritoDeCompraRequest(Integer codPedido,Integer idUsuario, Float subTotal, String estado ,String cupon,List<ProductoRequest> p) {
        this.codPedido = codPedido;
        this.idUsuario = idUsuario;
        this.subTotal = subTotal;
        this.estado = estado;
        this.listaProductosOrdenados = p;
        this.cupon = cupon==null ? "" : cupon;
    }
